  ...
  <div class="register">
    <div class="register-child">
      <div class="register-header">
        <img class="register-header-logo" src="../../assets/img/logo.png" alt="">
        <p>Q博客账号</p>
      </div>
      <div class="register-section">
        ...
        <p class="agreeAndRead">已阅读并同意：<strong>用户协议</strong>和 <strong>隐私政策</strong><input type="radio" value="boy" name="sex" @click="endRead" :checked = "Ischecked" /></p>
      </div>
